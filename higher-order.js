...
//Code Here
let myStrongest = monstersInYourPocket.filter((obj)=> obj.CP > 200);// = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
let orderTotals = orders.map((obj)=>(1+obj.tax)*obj.price);// Code here
